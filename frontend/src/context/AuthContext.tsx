...
const PUBLIC_ROUTES = ["/", "/login", "/signup", "/forgot-password", "/candidate/submit", "/candidate/interview", "/mock", "/pricing", "/daily", "/calendar", "/passport", "/quick-prep", "/topic-practice", "/resume-prep", "/cheat-sheet"];
