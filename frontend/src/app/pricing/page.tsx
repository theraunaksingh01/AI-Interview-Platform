...
const features: FeatureRow[] = [
  ...
  { label: "Build Your Answer — sentence-by-sentence practice",         free: false,        pro: false,        max: true },
  { label: "Topic Practice",                  section: "Practice Modes", free: "3 / month", pro: "Unlimited",  max: "Unlimited" },
  { label: "SQL Practice",                                              free: true,         pro: true,         max: true },
  { label: "Peer Practice — join rooms",                                free: true,         pro: true,         max: true },
  { label: "Peer Practice — create rooms",                              free: false,        pro: true,         max: true },
  { label: "Quick Prep — pre-interview revision",                       free: false,        pro: true,         max: true },
