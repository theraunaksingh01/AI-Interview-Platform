...
import { PUBLIC_PATHS_EXACT } from "@/lib/publicRoutes";
/**
 ...
 *
 * PUBLIC_PATHS_EXACT is imported from @/lib/publicRoutes — the single
 * source of truth shared with AuthContext.tsx. Add new public pages
 * there, not here.
 */
